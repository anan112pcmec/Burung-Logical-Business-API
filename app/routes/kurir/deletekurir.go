...
func DeleteKurirHandler(db *config.InternalDBReadWriteSystem, w http.ResponseWriter, r *http.Request, ms *minio.Client, rds_session *redis.Client, mb_cud_publisher *mb_cud_publisher.Publisher) {
	...
	case "/kurir/alamat/hapus-alamat":
		...
		hasil = kurir_alamat_services.HapusAlamatKurir(ctx, data, db, rds_session, mb_cud_publisher)
	case "/kurir/rekening/hapus-rekening":
		...
		hasil = kurir_rekening_services.HapusRekeningKurir(ctx, data, db, rds_session, mb_cud_publisher)
	case "/kurir/pengiriman/non-aktifkan-bid":
		...
		hasil = kurir_pengiriman_services.NonaktifkanBidKurir(ctx, data, db, rds_session, mb_cud_publisher)
	case "/kurir/media/hapus-foto-profil-kurir":
		...
		hasil = kurir_media_services.HapusKurirProfilFoto(ctx, data, db, rds_session, mb_cud_publisher)
	case "/kurir/media/hapus-foto-informasi-kendaraan-kurir-kendaraan":
		...
		hasil = kurir_media_services.HapusMediaInformasiKendaraanKurirKendaraanFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/kurir/media/hapus-foto-informasi-kendaraan-kurir-bpkb":
		...
		hasil = kurir_media_services.HapusInformasiKendaraanKurirBPKBFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/kurir/media/hapus-foto-informasi-kendaraan-kurir-stnk":
		...
		hasil = kurir_media_services.HapusInformasiKendaraanKurirSTNKFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/kurir/media/hapus-foto-informasi-kurir-ktp":
		...
		hasil = kurir_media_services.HapusMediaInformasiKurirKTPFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	}
