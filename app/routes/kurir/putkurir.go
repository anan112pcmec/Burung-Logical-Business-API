...
func PutKurirHandler(db *environment.InternalDBReadWriteSystem, w http.ResponseWriter, r *http.Request, ms *minio.Client, rds_session *redis.Client, mb_cud_publisher *mb_cud_publisher.Publisher) {
	...
	case "/kurir/media/ubah-foto-profil-kurir":
		...
		hasil = kurir_media_services.UbahKurirProfilFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/kurir/media/tambah-foto-informasi-kendaraan-kurir-kendaraan":
		...
		hasil = kurir_media_services.TambahMediaInformasiKendaraanKurirKendaraanFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/kurir/media/tambah-foto-informasi-kendaraan-kurir-bpkb":
		...
		hasil = kurir_media_services.TambahInformasiKendaraanKurirBPKBFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/kurir/media/tambah-foto-informasi-kendaraan-kurir-stnk":
		...
		hasil = kurir_media_services.TambahInformasiKendaraanKurirSTNKFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/kurir/media/tambah-foto-informasi-kurir-ktp":
		...
		hasil = kurir_media_services.TambahMediaInformasiKurirKTPFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/kurir/media/tambah-foto-pengiriman-non-ekspedisi-picked-up":
		...
		hasil = kurir_media_services.TambahMediaPengirimanPickedUpFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/kurir/media/tambah-foto-pengiriman-non-ekspedisi-sampai":
		...
		hasil = kurir_media_services.TambahMediaPengirimanSampaiFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/kurir/media/tambah-foto-pengiriman-ekspedisi-picked-up":
		...
		hasil = kurir_media_services.TambahMediaPengirimanEkspedisiPickedUpFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/kurir/media/tambah-foto-pengiriman-ekspedisi-sampai":
		...
		hasil = kurir_media_services.TambahMediaPengirimanEkspedisiSampaiAgentFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	}
