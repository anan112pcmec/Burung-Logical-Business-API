...
func PutSellerHandler(db *environment.InternalDBReadWriteSystem, w http.ResponseWriter, r *http.Request, ms *minio.Client, rds_session *redis.Client, mb_cud_publisher *mb_cud_publisher.Publisher) {
	...
	case "/seller/media/ubah-foto-profile":
		...
		hasil = seller_media_services.UbahFotoProfilSeller(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/seller/media/ubah-foto-banner":
		...
		hasil = seller_media_services.UbahFotoBannerSeller(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/seller/media/tambah-foto-toko-fisik":
		...
		hasil = seller_media_services.TambahkanFotoTokoFisikSeller(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/seller/media/ubah-foto-etalase":
		...
		hasil = seller_media_services.UbahFotoEtalaseSeller(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/seller/media/tambah-foto-barang-induk":
		...
		hasil = seller_media_services.TambahkanMediaBarangIndukFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/seller/media/ubah-video-barang-induk":
		...
		hasil = seller_media_services.UbahBarangIndukVideo(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/seller/media/ubah-foto-kategori-barang":
		...
		hasil = seller_media_services.UbahKategoriBarangFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/seller/media/tambah-dokumen-distributor-data":
		...
		hasil = seller_media_services.TambahDistributorDataDokumen(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/seller/media/tambah-foto-distributor-data-npwp":
		...
		hasil = seller_media_services.TambahMediaDistributorDataNPWPFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/seller/media/tambah-foto-distributor-data-nib":
		...
		hasil = seller_media_services.TambahDistributorDataNIBFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/seller/media/tambah-dokumen-distributor-data-surat-kerjasama":
		...
		hasil = seller_media_services.TambahDistributorDataSuratKerjasamaDokumen(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/seller/media/tambah-dokumen-brand-data-perwakilan":
		...
		hasil = seller_media_services.TambahBrandDataPerwakilanDokumen(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/seller/media/tambah-foto-brand-data-sertifikat":
		...
		hasil = seller_media_services.TambahMediaBrandDataSertifikatFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/seller/media/tambah-foto-brand-data-nib":
		...
		hasil = seller_media_services.TambahMediaBrandDataNIBFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/seller/media/tambah-foto-brand-data-npwp":
		...
		hasil = seller_media_services.TambahMediaBrandNPWPFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/seller/media/tambah-foto-brand-data-logo":
		...
		hasil = seller_media_services.TambahMediaBrandDataLogoFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/seller/media/tambah-dokumen-brand-data-surat-kerjasama":
		...
		hasil = seller_media_services.TambahBrandDataSuratKerjasamaDokumen(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/seller/media/tambah-foto-approve-transaksi":
		...
		hasil = seller_media_services.TambahMediaTransaksiApprovedFoto(ctx, data, db, ms, rds_session, mb_cud_publisher)
	case "/seller/media/tambah-video-approve-transaksi":
		...
		hasil = seller_media_services.TambahTransaksiApprovedVideo(ctx, data, db, ms, rds_session, mb_cud_publisher)
	}
