...
func (p PenggunaThreshold) Inisialisasi(id_fk int64, ctx context.Context, db *gorm.DB) error {
...
func (p PenggunaThreshold) Increment(id_fk int64, ctx context.Context, db *gorm.DB, koloms ...string) error {
...
func (p PenggunaThreshold) Decrement(id_fk int64, ctx context.Context, db *gorm.DB, koloms ...string) error {
	if len(koloms) == 0 {
		return fmt.Errorf("gagal data kosong")
	}
...
func (p PenggunaThreshold) CustomIncrement(id_fk int64, ctx context.Context, db *gorm.DB, kj []CustomCounter) error {
	if len(kj) == 0 {
		return fmt.Errorf("gagal data kosong")
	}
...
func (p PenggunaThreshold) CustomDecrement(id_fk int64, ctx context.Context, db *gorm.DB, kj []CustomCounter) error {
	if len(kj) == 0 {
		return fmt.Errorf("gagal data kosong")
	}
...
func (s SellerThreshold) Inisialisasi(id_fk int64, ctx context.Context, db *gorm.DB) error {
	var id_data_threshold int64 = 0
...
func (s SellerThreshold) Increment(id_fk int64, ctx context.Context, db *gorm.DB, koloms ...string) error {
...
func (s SellerThreshold) Decrement(id_fk int64, ctx context.Context, db *gorm.DB, koloms ...string) error {
	if len(koloms) == 0 {
		return fmt.Errorf("gagal data kosong")
	}
...
func (s SellerThreshold) CustomIncrement(id_fk int64, ctx context.Context, db *gorm.DB, kj []CustomCounter) error {
	if len(kj) == 0 {
		return fmt.Errorf("gagal data kosong")
	}
...
func (s SellerThreshold) CustomDecrement(id_fk int64, ctx context.Context, db *gorm.DB, kj []CustomCounter) error {
	if len(kj) == 0 {
		return fmt.Errorf("gagal data kosong")
	}
...
func (k KurirThreshold) Inisialisasi(id_fk int64, ctx context.Context, db *gorm.DB) error {
	var id_data_threshold int64 = 0
...
func (k KurirThreshold) Increment(id_fk int64, ctx context.Context, db *gorm.DB, koloms ...string) error {
...
func (k KurirThreshold) Decrement(id_fk int64, ctx context.Context, db *gorm.DB, koloms ...string) error {
	if len(koloms) == 0 {
		return fmt.Errorf("gagal data kosong")
	}
...
func (k KurirThreshold) CustomIncrement(id_fk int64, ctx context.Context, db *gorm.DB, kj []CustomCounter) error {
	if len(kj) == 0 {
		return fmt.Errorf("gagal data kosong")
	}
...
func (k KurirThreshold) CustomDecrement(id_fk int64, ctx context.Context, db *gorm.DB, kj []CustomCounter) error {
	if len(kj) == 0 {
		return fmt.Errorf("gagal data kosong")
	}
