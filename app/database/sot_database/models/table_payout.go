...
type PayOutKurir struct {
	...
	DeletedAt        gorm.DeletedAt `gorm:"index" json:"deleted_at,omitempty"` // 🔵 Wajib soft — data finansial
}
...
type PayOutSeller struct {
	...
	IdTransaksi      int64          `gorm:"column:id_transaksi;not null" json:"id_transaksi_payout_seller"`
